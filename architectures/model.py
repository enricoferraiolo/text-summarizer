...
class bohmodel:
    def __init__(self, x_voc, y_voc, max_text_len, max_summary_len, lstm_units=512, name="bohmodel"):
        self.x_voc = x_voc
        self.y_voc = y_voc
    ...
    def build_model(self):
        ...
        # Return the model
        return Model([encoder_inputs, decoder_inputs], decoder_outputs, name=f"{self.name}-Model")
